...
The percentages represented here show the time proportion with respect to the wall clock time during the execution of the parallel region of the benchmark.
%execution time represented here is the wall clock time during the parallel region of the benchmark.
...
As this runtime activity is shared among threads, the more the resources, the less the runtime activity per thread.
As a consequence, there is less runtime activity for the master thread.
